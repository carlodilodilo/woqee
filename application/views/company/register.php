<div id="doctorEditPg" class="container woqee_container">
  ...
  <div class="content_doctor_view">
    <div class="manage_info_top">
        Registration - <?php echo $officerInfo['cp_email'] ; ?>
    </div>

    <div class="doctor_profile">
      <?php if ( $exist ) : ?>
        You are already officer of <?php echo $companyInfo['c_desc'] ; ?> - <?php echo $officerInfo['cp_email'] ; ?>
        <a href="/">Login</a>
      <?php else : ?>
        <div id="success_holder" style="display: none;">
          You are now officer of <?php echo $companyInfo['c_desc'] ; ?>  - <?php echo $officerInfo['cp_email'] ; ?>
          <a href="/">Login</a>
        </div>
        ...
        <div id="form_holder">
          ...
          <input id="cp_id" type="hidden" value="<?php echo $officerInfo['cp_id'] ; ?>">
